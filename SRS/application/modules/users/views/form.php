...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <label for="password" class="col-sm-2 control-label">Password  Lama<span class="required-input">*</span></label>
            <div class="col-sm-3">                                   
                <?php
                echo form_input(
                        array(
        ...
        <!--Password Baru-->
        <div class="form-group">
            <label for="password" class="col-sm-2 control-label">Password Baru<span class="required-input">*</span></label>
            <div class="col-sm-3">                                   
                <?php
                echo form_input(
                        array(
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">                                   
                ...
                <div style="margin-top: 10px;"><img src="<?= base_url() ?>assets/img/<?= $users['foto'] ?>" height="180" width="320" /></div>
            </div>
        </div> <!--/ Foto -->
