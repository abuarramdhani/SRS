...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
    <td class="style19b" align="right" colspan="5">Form Surat Jalan</td>
    ...
    <tr>
        <td colspan="8" class="style6"><table width="99%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="2000"><span class="style9"><b>No Surat Jalan:
    ...
    <tr>
        <td colspan="9" class="style6"><hr /></td>
    </tr>
...
<!--
<table width="98%" border="1" align="right">
    <tr>

        <td colspan="3"><div style="margin-right:15px;" class="style9" align="right">Diterima Oleh</div></td>
        <td colspan="3"><div style="margin-right:15px;" class="style9" align="left">Diterima Oleh</div></td>
    </tr>
    <tr>
        <td align="right">&nbsp;</td>
    </tr>
